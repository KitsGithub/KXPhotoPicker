...
- (void)setupViews
{
    ...
    _backGroudView.backgroundColor = [UIColor colorFormHexRGB:dnSendButtonTintNormalColor];
    ...
    [_sendButton setTitleColor:[UIColor colorFormHexRGB:dnSendButtonTintNormalColor] forState:UIControlStateNormal];
    [_sendButton setTitleColor:[UIColor colorFormHexRGB:dnSendButtonTintAbnormalColor] forState:UIControlStateHighlighted];
    [_sendButton setTitleColor:[UIColor colorFormHexRGB:dnSendButtonTintAbnormalColor] forState:UIControlStateDisabled];
